...
double CartoonizeOMP::cDomain(int y, int x, int k, int l) {
    ...
    double denominator = 2 * pow(sigma_d, 2);  // Nenner
 ...
 * x = j
 */
double CartoonizeOMP::cEdge(const Image &img, int y, int x, int k, int l) {
    double r, g, b;
    ...
    double denominator = 2 * pow(sigma_r, 2);      // Nenner
 ...
 * w_ijkl Formel
 */
double CartoonizeOMP::weight(const Image &img, int y, int x, int k, int l) {
 ...
 */
double** CartoonizeOMP::initWeightKernel(const Image &img, int y, int x) {
    int height = 0;
    int width = 0;
 ...
 * g_ij-Kernel
 */
Pixel CartoonizeOMP::calcPixelBilFilter(const Image &img, int y, int x) {
 ...
 */
Pixel CartoonizeOMP::calcPixelBinFilter(const Image &img, int y, int x, char op) {
    int height = 0;
    int width  = 0;
 ...
 */
Image CartoonizeOMP::binImage(const Image &img) {
    Image gX;
    Image gY;
    Image G;
    Image G_t;
 ...
 */
Pixel CartoonizeOMP::calcPixelCartFilter(const Pixel &pixBilateral, const Pixel &pixBinary) {
    double r, g, b;
    r = pixBinary.r;
    g = pixBinary.g;
    b = pixBinary.b;
...
Image CartoonizeOMP::cartoonizeImage(Image &bilateral, Image &binary) {
